...
export function displayResult(P_baseOfDenominations: Base, P_statusMessages: string[], P_changeInDrawer: Denomination[], P_changeDue: number, P_price: number, P_cash: number, P_totalOfChangesInDrawer: number, P_totalOfTableOfChangesDues: number, P_getReminderFromTableOfChangesDues: GetReminderFromTableOfChangesDues, P_getTableOfChangesDues: GetTableOfChangesDues, P_getTableOfMaxDenominationCountDue: GetTableOfMaxDenominationCountDue, P_isEachCountOfChangesEnough: IsEachCountOfChangesEnough, P_makeChangeOperation: MakeChangeOperation, P_makeNewDrawer: MakeNewDrawer): string | [string, Denomination[]] | void
{
    ...
    {
        return P_statusMessages[0];
    }
    else
    {
        if (P_totalOfTableOfChangesDues && P_totalOfChangesInDrawer > P_changeDue)
        {
            if (P_isEachCountOfChangesEnough(P_changeDue, P_baseOfDenominations, P_changeInDrawer, P_getTableOfChangesDues, P_getTableOfMaxDenominationCountDue))
            {
                const changeUsed: Denomination[] = [];

                P_makeChangeOperation(changeUsed, P_changeDue, P_baseOfDenominations, P_changeInDrawer, P_getReminderFromTableOfChangesDues, P_getTableOfChangesDues, P_getTableOfMaxDenominationCountDue, P_makeNewDrawer);

                return [P_statusMessages[3], changeUsed];
            }
            else
            {
        ...
        else if (P_totalOfTableOfChangesDues && P_totalOfChangesInDrawer == P_changeDue)
        {
            ...
            return [P_statusMessages[2], changeUsed];
        }
...
export function getReminderFromTableOfChangesDues(P_changeUsed: Denomination[], P_changeDue: number, P_baseOfDenominations: Base, P_changeInDrawer: Denomination[], P_getTableOfChangesDues: GetTableOfChangesDues, P_getTableOfMaxDenominationCountDue: GetTableOfMaxDenominationCountDue, P_makeNewDrawer: MakeNewDrawer): number
{
...
export function getTableOfChangesDues(P_changeDue: number, P_baseOfDenominations: Base, P_changeInDrawer: Denomination[]): Denomination[]
{
...
export function getTableOfMaxDenominationCountDue(P_changeDue: number, baseOfDenominations: Base, P_tableOfChangeDue: Denomination[]): Denomination
{
...
export function getTotalOfTableOfChangesDue(P_price: number, P_cash: number, P_baseOfDenominations: Base, P_changeInDrawer: Denomination[], P_getTableOfChangesDues: GetTableOfChangesDues, P_getTotalOfTable: GetTotalOfTable): number
{
...
export function isEachCountOfChangesEnough(P_changeDue: number, P_baseOfDenominations: Base, P_changeInDrawer: Denomination[], P_getTableOfChangesDues: GetTableOfChangesDues, P_getTableOfMaxDenominationCountDue: GetTableOfMaxDenominationCountDue): boolean
{
...
export function makeChangeOperation(P_changeUsed: Denomination[], P_changeDue: number, P_baseOfDenominations: Base, P_changeInDrawer: Denomination[], P_getReminderFromTableOfChangesDues: GetReminderFromTableOfChangesDues, P_getTableOfChangesDues: GetTableOfChangesDues, P_getTableOfMaxDenominationCountDue: GetTableOfMaxDenominationCountDue, P_makeNewDrawer: MakeNewDrawer): void
{
...
export function makeNewDrawer(P_maxAmountDue: number, P_tableOfMaxDenominationCountDue: Denomination, P_changeInDrawer: Denomination[]): Denomination[]
{
